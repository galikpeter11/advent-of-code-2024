...
public class Part1 {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < groups.size(); i++) {
            // Iterate through each pair of coordinates in the group
            for (int j = 0; j < groups.get(i).size() - 1; j++) {
                for (int k = j + 1; k < groups.get(i).size(); k++) {
                    ...
                    int dx = a.x - b.x;
                    int dy = a.y - b.y;
                    if (a.x + dx >= 0 && a.x + dx < rows && a.y + dy >= 0 && a.y + dy < cols) {
                        //if (grid[a.x + dx][a.y + dy] == '.') {
                            grid[a.x + dx][a.y + dy] = '#';
                        //}
                    }

                    if (b.x - dx >= 0 && b.x - dx < rows && b.y - dy >= 0 && b.y - dy < cols) {
                        //if (grid[b.x - dx][b.y - dy] == '.') {
                            grid[b.x - dx][b.y - dy] = '#';
                        //}
                    }
                }
