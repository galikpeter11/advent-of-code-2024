...
//            int j = (m.p.y * m.a.x - m.p.x * m.a.y) / (m.b.y * m.a.x - m.b.x * m.a.y);
//            int i = (m.p.y * m.b.x - m.p.x * m.b.y) / (m.a.y * m.b.x - m.a.x * m.b.y);
            for (int i = 0; i * m.a.x <= m.p.x; i++) {
                int j = (m.p.x - i * m.a.x) / m.b.x;
